...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese un texto para encriptar: ");
        ...
        if (texto.length() <= 10) {
            ...
            System.out.println("El texto no cumple las condiciones para ser encriptado");
    ...
    public static String EncriptarSHA1(String texto) {
        try {
            ...
            byte[] hash = dig.digest(texto.getBytes());
